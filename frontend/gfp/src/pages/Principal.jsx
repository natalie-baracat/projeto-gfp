...
import {
    MdAccountBalance,
    MdAdd, MdAttachMoney, MdAutoGraph, MdCached, MdClose, MdCreditCard, MdEmail, MdFeaturedPlayList, MdGridView, MdLogout,
    MdMenu,
...
export default function Principal() {
    ...
    return (
        <div className='flex h-screen font-sans bg-gradient-to-bl from-[#710090] to-[#ffb20c]'>
            {/* div para fechar o menu clicando fora */}
            <div className={`fixed inset-0 bg-black opacity-20 z-30 md:hidden
                    ...
                    <div className='px-4 lg:px-6 mb-2'>
                        <Link to='/dashboard' onClick={() => setMenuAberto(false)}
                            className={`flex items-center gap-2 p-3 rounded-lg transition-colors
                                    ...
                                    'bg-[#b30098] text-white shadow-md' : 'hover:bg-[#5a0173]'
                                }
                                `}
                        >
